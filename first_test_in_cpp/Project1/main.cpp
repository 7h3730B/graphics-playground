...
private:
    ...
    // global variables that can be changed ad drawing time
    ...
    void createGraphicsPipeline() {
        ...
        // Input assembly State, descripes what kind of geometry will be drawn and if primitive restart should be enabled
        // Currently setup to only draw Triangles
        ...
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        // Use the size of the images in the swap chain
        ...
        // Scissor triangle (everything out of the triangle will not be renderd by the rasteriezer 
        // Here it covers the complete screen
        VkRect2D scissor{};
        scissor.offset = { 0, 0 };
        scissor.extent = swapChainExtent;

        // Combining the viewport with the scissor triangle (Could have multiple viewports and triangles (would need extra Feature))
        ...
        // VK_TRUE would disable the rasterizer
        rasterizer.rasterizerDiscardEnable = VK_FALSE;
        // VK_POLYGON_MODE_LINE would be Wireframe rendering I guess??????? Would need GPU Feature??????
        ...
        // VkPipelineDepthStencilStateCreateInfo not done yet

        // Color blending (here with settings per framebuffer)
        ...
        // Dynamic state allows to modify some values in the graphics pipeline without rebuilding it
